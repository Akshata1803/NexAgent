...
```
C:\Users\Akshata\OneDrive\Desktop\Project\NexAgent-main\          ← workspace root (NO .git)
...
```
C:\Users\Akshata\OneDrive\Desktop\Project\NexAgent-main\          ← workspace root (NO .git — unchanged)
...
1. Rename `C:\Users\Akshata\OneDrive\Desktop\Project\NexAgent-main\NexAgent\` → `C:\Users\Akshata\OneDrive\Desktop\Project\NexAgent-main\backend\`
2. Remove `C:\Users\Akshata\OneDrive\Desktop\Project\NexAgent-main\frontend\.git\` (single dummy commit, safe)
